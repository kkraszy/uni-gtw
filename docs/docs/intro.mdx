...
- The gateway runs on very [cheap hardware](./installation/supported_hardware.mdx) (can be DIY-ed for as little as ~30 pln) - just an ESP32 and CC1101 radio module
